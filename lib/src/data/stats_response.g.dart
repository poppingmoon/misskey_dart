      ...
      ($checkedConvert) {
        final val = _$StatsResponseImpl(
          ...
          originalNotesCount: $checkedConvert(
              'originalNotesCount', (v) => (v as num?)?.toInt()),
          usersCount:
              $checkedConvert('usersCount', (v) => (v as num?)?.toInt()),
          originalUsersCount: $checkedConvert(
              'originalUsersCount', (v) => (v as num?)?.toInt()),
          reactionsCount:
              $checkedConvert('reactionsCount', (v) => (v as num?)?.toInt()),
          instances: $checkedConvert('instances', (v) => (v as num?)?.toInt()),
          driveUsageLocal:
              $checkedConvert('driveUsageLocal', (v) => (v as num?)?.toInt()),
          driveUsageRemote:
              $checkedConvert('driveUsageRemote', (v) => (v as num?)?.toInt()),
        );
        return val;
      },
    );
