...
@override
String toString() {
  return 'FlashMyLikesRequest(limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
class _FlashMyLikesRequest implements FlashMyLikesRequest {
  const _FlashMyLikesRequest({this.limit, this.sinceId, this.untilId, @EpocTimeDateTimeConverter() this.sinceDate, @EpocTimeDateTimeConverter() this.untilDate});
