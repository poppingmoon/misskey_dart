...
abstract class $DriveFoldersCreateRequestCopyWith<$Res> {
  factory $DriveFoldersCreateRequestCopyWith(
    DriveFoldersCreateRequest value,
...
/// @nodoc
class _$DriveFoldersCreateRequestCopyWithImpl<
  $Res,
...
>
  ...
  @override
  $Res call({Object? name = freezed, Object? parentId = freezed}) {
    return _then(
      _value.copyWith(
            name:
                freezed == name
...
class _$DriveFoldersCreateRequestImpl implements _DriveFoldersCreateRequest {
  ...
  Map<String, dynamic> toJson() {
    return _$$DriveFoldersCreateRequestImplToJson(this);
  }
}
