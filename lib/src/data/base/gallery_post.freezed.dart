...
mixin _$GalleryPost {
 ...
 String get id; DateTime get createdAt; DateTime get updatedAt; String get userId; UserLite get user; String get title; String? get description; List<String> get fileIds; List<DriveFile> get files; List<String>? get tags; bool get isSensitive; int get likedCount; bool? get isLiked;
...
@useResult
$Res call({
 String id, DateTime createdAt, DateTime updatedAt, String userId, UserLite user, String title, String? description, List<String> fileIds, List<DriveFile> files, List<String>? tags, bool isSensitive, int likedCount, bool? isLiked
});
