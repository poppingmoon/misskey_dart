...
/// Adds pattern-matching-related methods to [NoteSchedule].
extension NoteSchedulePatterns on NoteSchedule {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NoteSchedule value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NoteSchedule() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NoteSchedule value)  $default,){
final _that = this;
switch (_that) {
case _NoteSchedule():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NoteSchedule value)?  $default,){
final _that = this;
switch (_that) {
case _NoteSchedule() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  NoteScheduleNote note,  String userId, @DateTimeConverter()  DateTime scheduledAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteSchedule() when $default != null:
return $default(_that.id,_that.note,_that.userId,_that.scheduledAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  NoteScheduleNote note,  String userId, @DateTimeConverter()  DateTime scheduledAt)  $default,) {final _that = this;
switch (_that) {
case _NoteSchedule():
return $default(_that.id,_that.note,_that.userId,_that.scheduledAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  NoteScheduleNote note,  String userId, @DateTimeConverter()  DateTime scheduledAt)?  $default,) {final _that = this;
switch (_that) {
case _NoteSchedule() when $default != null:
return $default(_that.id,_that.note,_that.userId,_that.scheduledAt);case _:
  return null;
...
/// Adds pattern-matching-related methods to [NoteScheduleNote].
extension NoteScheduleNotePatterns on NoteScheduleNote {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NoteScheduleNote value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NoteScheduleNote() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NoteScheduleNote value)  $default,){
final _that = this;
switch (_that) {
case _NoteScheduleNote():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NoteScheduleNote value)?  $default,){
final _that = this;
switch (_that) {
case _NoteScheduleNote() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? text,  String? cw,  List<String> fileIds, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  NoteVisibility? visibility,  List<UserLite> visibleUsers,  UserLite user, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  ReactionAcceptance? reactionAcceptance,  bool? isSchedule)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteScheduleNote() when $default != null:
return $default(_that.text,_that.cw,_that.fileIds,_that.visibility,_that.visibleUsers,_that.user,_that.reactionAcceptance,_that.isSchedule);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? text,  String? cw,  List<String> fileIds, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  NoteVisibility? visibility,  List<UserLite> visibleUsers,  UserLite user, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  ReactionAcceptance? reactionAcceptance,  bool? isSchedule)  $default,) {final _that = this;
switch (_that) {
case _NoteScheduleNote():
return $default(_that.text,_that.cw,_that.fileIds,_that.visibility,_that.visibleUsers,_that.user,_that.reactionAcceptance,_that.isSchedule);case _:
  throw StateError('Unexpected subclass');
