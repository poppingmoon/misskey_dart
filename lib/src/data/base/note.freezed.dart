...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt,@NullableDateTimeConverter() DateTime? updatedAt, String? text, String? cw, UserLite user, String userId,@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) NoteVisibility? visibility, bool localOnly, int renoteCount, int repliesCount, int? reactionCount, Map<String, int> reactions,@EmojisConverter() Map<String, String> reactionEmojis,@EmojisConverter() Map<String, String> emojis, List<String> fileIds, List<DriveFile> files, String? replyId, String? renoteId, String? channelId,@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ReactionAcceptance? reactionAcceptance, Note? renote, Note? reply, List<String> visibleUserIds, List<String> mentions, String? myReaction, NoteChannelInfo? channel,@NullableUriConverter() Uri? uri,@NullableUriConverter() Uri? url, List<String> reactionAndUserPairCache, NotePoll? poll, int? clippedCount, bool? isRenoted
});


$UserLiteCopyWith<$Res> get user;$NoteCopyWith<$Res>? get renote;$NoteCopyWith<$Res>? get reply;$NoteChannelInfoCopyWith<$Res>? get channel;$NotePollCopyWith<$Res>? get poll;
...
as ReactionAcceptance?,renote: freezed == renote ? _self.renote : renote // ignore: cast_nullable_to_non_nullable
as Note?,reply: freezed == reply ? _self.reply : reply // ignore: cast_nullable_to_non_nullable
as Note?,visibleUserIds: null == visibleUserIds ? _self.visibleUserIds : visibleUserIds // ignore: cast_nullable_to_non_nullable
...
as int?,isRenoted: freezed == isRenoted ? _self.isRenoted : isRenoted // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
/// Create a copy of Note
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt, @NullableDateTimeConverter()  DateTime? updatedAt,  String? text,  String? cw,  UserLite user,  String userId, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  NoteVisibility? visibility,  bool localOnly,  int renoteCount,  int repliesCount,  int? reactionCount,  Map<String, int> reactions, @EmojisConverter()  Map<String, String> reactionEmojis, @EmojisConverter()  Map<String, String> emojis,  List<String> fileIds,  List<DriveFile> files,  String? replyId,  String? renoteId,  String? channelId, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue)  ReactionAcceptance? reactionAcceptance,  Note? renote,  Note? reply,  List<String> visibleUserIds,  List<String> mentions,  String? myReaction,  NoteChannelInfo? channel, @NullableUriConverter()  Uri? uri, @NullableUriConverter()  Uri? url,  List<String> reactionAndUserPairCache,  NotePoll? poll,  int? clippedCount,  bool? isRenoted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.text,_that.cw,_that.user,_that.userId,_that.visibility,_that.localOnly,_that.renoteCount,_that.repliesCount,_that.reactionCount,_that.reactions,_that.reactionEmojis,_that.emojis,_that.fileIds,_that.files,_that.replyId,_that.renoteId,_that.channelId,_that.reactionAcceptance,_that.renote,_that.reply,_that.visibleUserIds,_that.mentions,_that.myReaction,_that.channel,_that.uri,_that.url,_that.reactionAndUserPairCache,_that.poll,_that.clippedCount,_that.isRenoted);case _:
  return orElse();
...
@override $UserLiteCopyWith<$Res> get user;@override $NoteCopyWith<$Res>? get renote;@override $NoteCopyWith<$Res>? get reply;@override $NoteChannelInfoCopyWith<$Res>? get channel;@override $NotePollCopyWith<$Res>? get poll;
...
as ReactionAcceptance?,renote: freezed == renote ? _self.renote : renote // ignore: cast_nullable_to_non_nullable
as Note?,reply: freezed == reply ? _self.reply : reply // ignore: cast_nullable_to_non_nullable
as Note?,visibleUserIds: null == visibleUserIds ? _self._visibleUserIds : visibleUserIds // ignore: cast_nullable_to_non_nullable
...
mixin _$NotePoll {
 ...
 bool get multiple;@DateTimeConverter() DateTime? get expiresAt; List<NotePollChoice> get choices;
...
@useResult
$Res call({
 bool multiple,@DateTimeConverter() DateTime? expiresAt, List<NotePollChoice> choices
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool multiple, @DateTimeConverter()  DateTime? expiresAt,  List<NotePollChoice> choices)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotePoll() when $default != null:
return $default(_that.multiple,_that.expiresAt,_that.choices);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool multiple, @DateTimeConverter()  DateTime? expiresAt,  List<NotePollChoice> choices)  $default,) {final _that = this;
switch (_that) {
case _NotePoll():
return $default(_that.multiple,_that.expiresAt,_that.choices);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool multiple, @DateTimeConverter()  DateTime? expiresAt,  List<NotePollChoice> choices)?  $default,) {final _that = this;
switch (_that) {
case _NotePoll() when $default != null:
return $default(_that.multiple,_that.expiresAt,_that.choices);case _:
  return null;
...
/// Create a copy of NotePoll
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? multiple = null,Object? expiresAt = freezed,Object? choices = null,}) {
  return _then(_NotePoll(
multiple: null == multiple ? _self.multiple : multiple // ignore: cast_nullable_to_non_nullable
as bool,expiresAt: freezed == expiresAt ? _self.expiresAt : expiresAt // ignore: cast_nullable_to_non_nullable
as DateTime?,choices: null == choices ? _self._choices : choices // ignore: cast_nullable_to_non_nullable
as List<NotePollChoice>,
  ));
}
...
class _NotePollChoice implements NotePollChoice {
  const _NotePollChoice({required this.text, required this.votes, this.isVoted = false});
