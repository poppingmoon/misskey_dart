...
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) FFVisibility? get followingVisibility;// ignore: invalid_annotation_target
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ChatScope? get chatScope; bool? get canChat;// Removed in Misskey 2024.10.0
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(emojis),onlineStatus,const DeepCollectionEquality().hash(badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore,speakAsCat,url,uri,movedTo,const DeepCollectionEquality().hash(alsoKnownAs),createdAt,updatedAt,lastFetchedAt,bannerUrl,bannerBlurhash,isLocked,isSilenced,isSuspended,description,location,birthday,lang,const DeepCollectionEquality().hash(fields),const DeepCollectionEquality().hash(verifiedLinks),const DeepCollectionEquality().hash(mutualLinkSections),followersCount,followingCount,notesCount,const DeepCollectionEquality().hash(pinnedNoteIds),const DeepCollectionEquality().hash(pinnedNotes),pinnedPageId,const DeepCollectionEquality().hash(pinnedPage),publicReactions,ffVisibility,followersVisibility,followingVisibility,chatScope,canChat,twoFactorEnabled,usePasswordLessLogin,securityKeys,const DeepCollectionEquality().hash(roles),memo,moderationNote]);
...
// ignore: invalid_annotation_target
@override@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) final  ChatScope? chatScope;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(_avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(_emojis),onlineStatus,const DeepCollectionEquality().hash(_badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore,speakAsCat,url,uri,movedTo,const DeepCollectionEquality().hash(_alsoKnownAs),createdAt,updatedAt,lastFetchedAt,bannerUrl,bannerBlurhash,isLocked,isSilenced,isSuspended,description,location,birthday,lang,const DeepCollectionEquality().hash(_fields),const DeepCollectionEquality().hash(_verifiedLinks),const DeepCollectionEquality().hash(_mutualLinkSections),followersCount,followingCount,notesCount,const DeepCollectionEquality().hash(_pinnedNoteIds),const DeepCollectionEquality().hash(_pinnedNotes),pinnedPageId,const DeepCollectionEquality().hash(_pinnedPage),publicReactions,ffVisibility,followersVisibility,followingVisibility,chatScope,canChat,twoFactorEnabled,usePasswordLessLogin,securityKeys,const DeepCollectionEquality().hash(_roles),memo,moderationNote]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,username,host,avatarUrl,avatarBlurhash,const DeepCollectionEquality().hash(avatarDecorations),isBot,isCat,instance,const DeepCollectionEquality().hash(emojis),onlineStatus,const DeepCollectionEquality().hash(badgeRoles),requireSigninToViewContents,makeNotesFollowersOnlyBefore,makeNotesHiddenBefore,speakAsCat,url,uri,movedTo,const DeepCollectionEquality().hash(alsoKnownAs),createdAt,updatedAt,lastFetchedAt,bannerUrl,bannerBlurhash,isLocked,isSilenced,isSuspended,description,location,birthday,lang,const DeepCollectionEquality().hash(fields),const DeepCollectionEquality().hash(verifiedLinks),const DeepCollectionEquality().hash(mutualLinkSections),followersCount,followingCount,notesCount,const DeepCollectionEquality().hash(pinnedNoteIds),const DeepCollectionEquality().hash(pinnedNotes),pinnedPageId,const DeepCollectionEquality().hash(pinnedPage),publicReactions,ffVisibility,followersVisibility,followingVisibility,chatScope,canChat,twoFactorEnabled,usePasswordLessLogin,securityKeys,const DeepCollectionEquality().hash(roles),memo,moderationNote,isFollowing,isFollowed,hasPendingFollowRequestFromYou,hasPendingFollowRequestToYou,isBlocking,isBlocked,isMuted,isRenoteMuted,notify,withReplies,followedMessage]);
...
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) FFVisibility? get followersVisibility;// ignore: invalid_annotation_target
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) FFVisibility? get followingVisibility;// ignore: invalid_annotation_target
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ChatScope? get chatScope; bool? get canChat; bool? get twoFactorEnabled;// Added in Misskey 11.25.0
// Removed in Misskey 2024.10.0
...
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) TwoFactorBackupCodesStock? get twoFactorBackupCodesStock;// Added in Misskey 12.77.0
 ...
 bool get hasUnreadChannel; bool? get hasUnreadChatMessages; bool get hasUnreadNotification;// Added in Misskey 12.11.0
...
mixin _$UserPolicies {
 ...
 bool? get canInvite; int? get inviteLimit; int? get inviteLimitCycle; int? get inviteExpirationTime; bool? get canManageCustomEmojis; bool? get canSearchNotes; bool? get canUseTranslator; bool? get canHideAds; int? get driveCapacityMb; int? get maxFileSizeMb; List<String>? get uploadableFileTypes; bool? get alwaysMarkNsfw; bool? get canUpdateBioMedia; int? get pinLimit; int? get antennaLimit; int? get wordMuteLimit; int? get webhookLimit; int? get clipLimit; int? get noteEachClipsLimit; int? get userListLimit; int? get userEachUserListsLimit; int? get rateLimitFactor; int? get avatarDecorationLimit; bool? get canImportAntennas; bool? get canImportBlocking; bool? get canImportFollowing; bool? get canImportMuting; bool? get canImportUserLists;// ignore: invalid_annotation_target
@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ChatAvailability? get chatAvailability; int? get noteDraftLimit; int? get mutualLinkSectionLimit;// MisskeyIO
...
as int?,mutualLinkSectionLimit: freezed == mutualLinkSectionLimit ? _self.mutualLinkSectionLimit : mutualLinkSectionLimit // ignore: cast_nullable_to_non_nullable
...
class _UserPolicies implements UserPolicies {
  const _UserPolicies({this.gtlAvailable, this.ltlAvailable, this.canPublicNote, this.mentionLimit, this.canEditNote, this.canScheduleNote, this.scheduleNoteLimit, this.scheduleNoteMaxDays, this.canInvite, this.inviteLimit, this.inviteLimitCycle, this.inviteExpirationTime, this.canManageCustomEmojis, this.canSearchNotes, this.canUseTranslator, this.canHideAds, this.driveCapacityMb, this.maxFileSizeMb, final  List<String>? uploadableFileTypes, this.alwaysMarkNsfw, this.canUpdateBioMedia, this.pinLimit, this.antennaLimit, this.wordMuteLimit, this.webhookLimit, this.clipLimit, this.noteEachClipsLimit, this.userListLimit, this.userEachUserListsLimit, this.rateLimitFactor, this.avatarDecorationLimit, this.canImportAntennas, this.canImportBlocking, this.canImportFollowing, this.canImportMuting, this.canImportUserLists, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.chatAvailability, this.noteDraftLimit, this.mutualLinkSectionLimit, this.mutualLinkLimit, this.scheduleNoteMax}): _uploadableFileTypes = uploadableFileTypes;
...
// ignore: invalid_annotation_target
@override@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) final  ChatAvailability? chatAvailability;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,note,follow,mention,reply,renote,quote,reaction,pollEnded,receiveFollowRequest,followRequestAccepted,roleAssigned,chatRoomInvitationReceived,achievementEarned,app,test);
...
class _NotificationRecieveConfigs implements NotificationRecieveConfigs {
  const _NotificationRecieveConfigs({this.note, this.follow, this.mention, this.reply, this.renote, this.quote, this.reaction, this.pollEnded, this.receiveFollowRequest, this.followRequestAccepted, this.roleAssigned, this.chatRoomInvitationReceived, this.achievementEarned, this.app, this.test});
