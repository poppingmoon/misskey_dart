...
class _UsersPagesRequest implements UsersPagesRequest {
  const _UsersPagesRequest({required this.userId, this.limit, this.sinceId, this.untilId, @EpocTimeDateTimeConverter() this.sinceDate, @EpocTimeDateTimeConverter() this.untilDate});
