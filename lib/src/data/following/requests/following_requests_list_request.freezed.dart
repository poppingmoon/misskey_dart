...
mixin _$FollowingRequestsListRequest {
 ...
 String? get sinceId; String? get untilId;@EpocTimeDateTimeConverter() DateTime? get sinceDate;@EpocTimeDateTimeConverter() DateTime? get untilDate; int? get limit;
...
class _FollowingRequestsListRequest implements FollowingRequestsListRequest {
  const _FollowingRequestsListRequest({this.sinceId, this.untilId, @EpocTimeDateTimeConverter() this.sinceDate, @EpocTimeDateTimeConverter() this.untilDate, this.limit});
