...
_$NotesScheduleCreateRequestImpl _$$NotesScheduleCreateRequestImplFromJson(
    ...
    $checkedCreate(
      r'_$NotesScheduleCreateRequestImpl',
      json,
      ($checkedConvert) {
        final val = _$NotesScheduleCreateRequestImpl(
          ...
          disableRightClick:
              $checkedConvert('disableRightClick', (v) => v as bool?),
          noExtractMentions:
          ...
          scheduleNote: $checkedConvert('scheduleNote',
...
Map<String, dynamic> _$$ScheduleNoteImplToJson(_$ScheduleNoteImpl instance) =>
    <String, dynamic>{
      'scheduledAt':
          const EpocTimeDateTimeConverter().toJson(instance.scheduledAt),
    };

_$ScheduledDeleteImpl _$$ScheduledDeleteImplFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      r'_$ScheduledDeleteImpl',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$$ScheduledDeleteImplToJson(
    ...
    <String, dynamic>{
      'deleteAt': _$JsonConverterToJson<int, DateTime>(
          instance.deleteAt, const EpocTimeDateTimeConverter().toJson),
      'deleteAfter': _$JsonConverterToJson<int, Duration>(
          instance.deleteAfter, const DurationConverter().toJson),
    };
