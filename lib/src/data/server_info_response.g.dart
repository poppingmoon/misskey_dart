...
) => $checkedCreate(r'_$ServerInfoResponseImpl', json, ($checkedConvert) {
...
_$ServerInfoCpuImpl _$$ServerInfoCpuImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$ServerInfoCpuImpl', json, ($checkedConvert) {
...
_$ServerInfoMemImpl _$$ServerInfoMemImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$ServerInfoMemImpl', json, ($checkedConvert) {
...
_$ServerInfoFsImpl _$$ServerInfoFsImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$ServerInfoFsImpl', json, ($checkedConvert) {
