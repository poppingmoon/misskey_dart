...
@NullableUriConverter() Uri? get serverErrorImageUrl;@NullableUriConverter() Uri? get notFountImageUrl;@NullableUriConverter() Uri? get iconUrl;@NullableUriConverter() Uri? get backgroundImageUrl;@NullableUriConverter() Uri? get logoImageUrl;@NullableUriConverter() Uri? get impressumUrl;@NullableUriConverter() Uri? get privacyPolicyUrl; int? get maxNoteTextLength; List<MetaAd> get ads; int? get notesPerOneAd; List<String> get serverRules; UserPolicies? get policies;@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) MetaFederation? get federation; bool? get requireSetup; bool? get enableEmail; bool? get enableServiceWorker; bool? get translatorAvailable; String? get proxyAccountName; String? get mediaProxy; bool? get enableUrlPreview; bool? get enableSkebStatus; bool? get cacheRemoteFiles; bool? get cacheRemoteSensitiveFiles; MetaFeature? get features;
...
as UserPolicies?,federation: freezed == federation ? _self.federation : federation // ignore: cast_nullable_to_non_nullable
as MetaFederation?,requireSetup: freezed == requireSetup ? _self.requireSetup : requireSetup // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) final  MetaFederation? federation;
