...
@override
String toString() {
  return 'ChatMessagesUserTimelineRequest(userId: $userId, limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
class _ChatMessagesUserTimelineRequest implements ChatMessagesUserTimelineRequest {
  const _ChatMessagesUserTimelineRequest({required this.userId, this.limit, this.sinceId, this.untilId, @EpocTimeDateTimeConverter() this.sinceDate, @EpocTimeDateTimeConverter() this.untilDate});
