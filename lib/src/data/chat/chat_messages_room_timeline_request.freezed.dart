...
@override
String toString() {
  return 'ChatMessagesRoomTimelineRequest(roomId: $roomId, limit: $limit, sinceId: $sinceId, untilId: $untilId, sinceDate: $sinceDate, untilDate: $untilDate)';
}
...
class _ChatMessagesRoomTimelineRequest implements ChatMessagesRoomTimelineRequest {
  const _ChatMessagesRoomTimelineRequest({required this.roomId, this.limit, this.sinceId, this.untilId, @EpocTimeDateTimeConverter() this.sinceDate, @EpocTimeDateTimeConverter() this.untilDate});
