...
mixin _$ChatMessage {
 ...
 String get id;@DateTimeConverter() DateTime get createdAt; String? get text; String get fromUserId; UserLite? get fromUser; String? get toUserId; UserLite? get toUser; String? get toRoomId; ChatRoom? get toRoom; String? get fileId; DriveFile? get file; bool? get isRead; List<ChatMessageReaction> get reactions;
...
@useResult
$Res call({
 String id,@DateTimeConverter() DateTime createdAt, String? text, String fromUserId, UserLite? fromUser, String? toUserId, UserLite? toUser, String? toRoomId, ChatRoom? toRoom, String? fileId, DriveFile? file, bool? isRead, List<ChatMessageReaction> reactions
});
...
as ChatRoom?,fileId: freezed == fileId ? _self.fileId : fileId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @DateTimeConverter()  DateTime createdAt,  String? text,  String fromUserId,  UserLite? fromUser,  String? toUserId,  UserLite? toUser,  String? toRoomId,  ChatRoom? toRoom,  String? fileId,  DriveFile? file,  bool? isRead,  List<ChatMessageReaction> reactions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatMessage() when $default != null:
return $default(_that.id,_that.createdAt,_that.text,_that.fromUserId,_that.fromUser,_that.toUserId,_that.toUser,_that.toRoomId,_that.toRoom,_that.fileId,_that.file,_that.isRead,_that.reactions);case _:
  return orElse();
...
@override@JsonKey() List<ChatMessageReaction> get reactions {
